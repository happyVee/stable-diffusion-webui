...
COPY runpod_requirement.txt /requirements.txt
...
RUN pip install --upgrade pip && \
    ...
    # pip3 install torch==2.0.1+cu118 --extra-index-url https://download.pytorch.org/whl/cu117 && \
    # pip3 install torchvision==0.15.2+cu118 --extra-index-url https://download.pytorch.org/whl/cu117 && \
